...
The system SHALL target p95 first-response latency below 2.5 seconds for session-based dialogue turns.

#### Scenario: Latency is measured per turn
- **WHEN** a dialogue turn completes in session mode
